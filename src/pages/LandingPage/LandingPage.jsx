    ...
    <main className={styles.main}>
      <section className={styles.LandingPageTopSection}>
        ...
        <div className={styles.topRightContent}>
          ...
          <button className={styles.LandingPageTopBtn} onClick={handleShopNow}>
            SHOP NOW
          </button>
        </div>
      </section>
      ...
      <section className={styles.carouselSection}>
        ...
        <div
          ...
          style={{
            transform: `translateX(-${
              currentIndex * (100 / allSnacks.length)
            }%)`, // Moves the carousel to show the current slide， if currentIndex=2, 2*100/16=12.5% ， translateX - means move to left.
        ...
        >
          {allSnacks.map((snack) => (
            <div key={snack.id} className={styles.carouselItem}>
      ...
      <div className={styles.onlyShowInSmallScreenSection}>
        <section className={styles.topSellSnacksSection}>
          <p className={styles.topSellSnackP}>
            Shop Our Best Selling Snack Boxes and Gifts
          </p>
